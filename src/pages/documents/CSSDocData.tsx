export const categoryDescriptions = {
  ...
  "Borders": "We all need a good form. Here you get to learn what blocks are responsible for making forms.",
  "Layout": "We all need a good form. Here you get to learn what blocks are responsible for making forms.",
  "More": "We all need a good form. Here you get to learn what blocks are responsible for making forms.",
};
...
export const blocks = [

  {
    title: "CSS Block",
    description:
      "When you build a HTML Web Page, this is the very first block that you should use. This block has two parts. The head section and then body section. Head section will contain additional information about the web page. Body section will contain all the contents of the web page.",
    image:
